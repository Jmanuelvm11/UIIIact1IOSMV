...
class NavaApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: EsScaffold(title: 'Flutter en Español Valenzuela'),
    ); // fin de material
  } // fin de widget
} // fin de NavaApp
    ...
    return Scaffold(
      ...
      drawer: Drawer(
        child: Column(mainAxisAlignment: MainAxisAlignment.center, children: <Widget>[
          ...
          Text('Drawer 1 Valenzuela'),
        ]), //Fin de columna
      ), //Fin drawer 1
      endDrawer: Drawer(
        child: Column(mainAxisAlignment: MainAxisAlignment.center, children: <Widget>[
          FlutterLogo(size: 100.0),
          Text('Drawer 2 Valenzuela end'),
        ]), //Fin de columna
      ), //Fin endDrawer 2
            ...
            builder: (BuildContext context) {
              return Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    FlutterLogo(size: 100.0),
                    Text('Bottom sheet de Valenzuela'),
                  ],
                ),
              ); //Fin Container
            }, //Fin builder
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: <Widget>[
              ...
              Text('bottomNavigationBar con BottomAppBar Valenzuela')
            ], // Fin <Widget>
          ), //Fin Row
        ), //Fin Container
      ), //Fin bottom aPPBar
